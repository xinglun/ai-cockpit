...
- Changed path: .ai/work-items/active/WI-985-repository-resource-lifecycle.contract.json
- Changed path: .ai/work-items/active/WI-985-repository-resource-lifecycle.summary.json
