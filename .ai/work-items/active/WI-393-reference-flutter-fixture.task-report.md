...
- Work Item: `WI-393-reference-flutter-fixture`
- Status: `verified`
...
- Establish auditable semantic parity and inheritance boundaries for the four pinned examples/fixtures/flutter-app files.
...
- .ai/evidence/WI-393-reference-flutter-fixture.verification.json
