...
- Work Item: `WI-968-release-v0-2-105`
- Status: `verified`
...
- 发布 v0.2.105，并取得不可变 tag、GitHub Release、候选与公开安装/升级验收、artifact manifest/checksums/SBOM/provenance 与清理证据；完成发布 WI 的最终 Outcome。
...
- .ai/evidence/WI-968-release-v0-2-105.verification.json
