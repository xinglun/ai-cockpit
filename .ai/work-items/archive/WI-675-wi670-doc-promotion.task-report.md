...
- Work Item: `WI-675-wi670-doc-promotion`
- Status: `verified`
...
- Synchronize the WI-670 Work Item pages and reference-parity rows so the closed-work-item promotion gate passes.
...
- .ai/evidence/WI-675-wi670-doc-promotion.verification.json
