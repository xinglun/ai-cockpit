...
- Work Item: `WI-600-release-v0-2-79`
- Status: `verified`
...
- Release the reviewed Runtime and verify that a fresh adopter can use only the published artifact.
...
- .ai/evidence/WI-600-release-v0-2-79.verification.json
