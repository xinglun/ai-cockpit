...
- Work Item: `WI-139B-recovery-events`
- Status: `verified`
...
- Make failed finish and downstream lifecycle gates visible, identity-bound, and recoverable for humans and Agents.
...
- .ai/evidence/WI-139B-recovery-events.verification.json
