...
- Work Item: `WI-182-parallel-lease-atomic-install`
- Status: `verified`
...
- Eliminate the parallel slot EOF race and prove concurrent first-use acquisition is fail-safe and race-safe.
