...
- Work Item: `WI-295-governance-gate-recovery-closure`
- Status: `verified`
...
- Keep historical retry evidence visible without blocking a valid closed Work Item.
...
- .ai/evidence/WI-295-governance-gate-recovery-closure.verification.json
