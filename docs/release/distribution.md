...
The current release artifact naming is `ai-cockpit-v0.2.99-<target>.tar.gz` or
...
The current installation baseline target is the `v0.2.99` candidate; it becomes
