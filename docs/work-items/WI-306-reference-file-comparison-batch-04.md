...
title: "WI-306 — reference evidence, trust, and rollback-corruption batch 04"
workItemId: WI-306-reference-file-comparison-batch-04
description: "Compare four pinned reference files and record Rust-native, adopter-readable parity boundaries."
audience:
  - maintainer
  - reviewer
status: in progress
lastVerifiedBy: WI-306-reference-file-comparison-batch-04
authority: canonical
---

# WI-306 — reference evidence, trust, and rollback-corruption batch 04
...
4. Inventory, comparison, parity, and this Work Item are synchronized; no
   WI-306 record remains deferred and no `migrate-gap` is introduced.
