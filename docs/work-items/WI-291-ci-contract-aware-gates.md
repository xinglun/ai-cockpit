...
description: "Immutable failed delivery preserved after hosted stale-parity rejection; WI-292 and WI-293 preserve the successive recovery history."
audience:
  - maintainer
  - reviewer
status: recovered
...
verification. Its lifecycle bytes remain immutable; WI-292 and WI-293 are the explicit
...
- Re-deliver the same implementation only through the successor chain (WI-292, then WI-293) from the latest remote
  default branch.
...
The hosted PR result is retained as failed delivery evidence; WI-293 owns the
