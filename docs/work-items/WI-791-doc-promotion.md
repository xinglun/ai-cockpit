...
title: "WI-791 — documentation promotion for WI-785 and WI-787"
...
[简体中文](WI-791-doc-promotion.zh-CN.md) · [日本語](WI-791-doc-promotion.ja.md)

# WI-791 — documentation promotion for WI-785 and WI-787

## Intent and boundary

WI-791 is a bounded documentation Work Item. It promotes the terminal WI-787
...
- WI-791's own three pages and parity rows are registered before archive.
