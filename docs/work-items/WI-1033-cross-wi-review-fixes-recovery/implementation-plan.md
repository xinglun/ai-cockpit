...
- Declare all twenty-five acceptance criteria, the twenty required scenarios with both expected results and verification plans, required evidence classes, and the correct canonical docs command.
