...
WI-498 作为不可变 recovery 历史保留。其 Hosted checks 在 archive 前通过，
但 parity 行与 verification evidence 在同一提交中引入，无法提供严格的
归档前顺序证明。WI-499 是明确的 successor：保留这些 bytes，并先提交 parity
登记，再生成 verification evidence。
