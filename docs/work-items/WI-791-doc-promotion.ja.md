...
title: "WI-791 — WI-785 と WI-787 のドキュメント投影"
...
[English](WI-791-doc-promotion.md) · [简体中文](WI-791-doc-promotion.zh-CN.md)

# WI-791 — WI-785 と WI-787 のドキュメント投影

## Intent と境界

WI-791 は bounded な documentation Work Item です。不変の Runtime 記録から
...
- WI-791 自身の三言語ページと parity row が archive 前に登録される。
