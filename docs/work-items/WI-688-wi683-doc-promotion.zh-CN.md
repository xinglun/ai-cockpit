...
title: "WI-688——WI-683 终态文档晋级"
description: "使用不可变终态证据晋级已验证的 WI-683 文档投影。"
...
[English](WI-688-wi683-doc-promotion.md) · [日本語](WI-688-wi683-doc-promotion.ja.md)

# WI-688——WI-683 终态文档晋级

## 意图

将三语 WI-683 Work Item 页面和 reference-parity 行与不可变的 archive、verification、
...
- 三语 WI-683 页面在验证关闭后显示终态状态并绑定精确证据路径。
- 三条 WI-683 parity 行显示对应终态和证据路径。
