...
title: "WI-306 — reference evidence、trust、rollback-corruption batch 04"
...
# WI-306 — reference evidence、trust、rollback-corruption batch 04
...
4. inventory、comparison、parity、Work Item を同期し、WI-306 を deferred に残さず
   `migrate-gap` を追加しません。
