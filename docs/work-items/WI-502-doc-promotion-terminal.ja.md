...
title: "WI-502 — WI-501 の terminal documentation projection"
description: "close 後の gate が検出した conditional status を修正し、WI-501 の文書と parity projection を terminal に昇格します。"
...
# WI-502 — WI-501 の terminal documentation projection

[English](WI-502-doc-promotion-terminal.md) · [简体中文](WI-502-doc-promotion-terminal.zh-CN.md)

## Boundary

この限定 documentation Work Item は、WI-501 の close 後に必須 promotion gate が
...
- WI-501 の English、簡体中文、日本語 page を evidence-backed terminal status へ昇格する。
...
- WI-501 の 3 言語 page が terminal evidence path と `status: implemented` を持つ。
- WI-501 の 3 parity row が `Implemented` で、正確な terminal record にリンクする。
