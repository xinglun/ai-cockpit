...
# WI-570 — v0.2.74 release and public-artifact acceptance

## Objective

Publish v0.2.74 from the reviewed, synchronized default branch as an
...
1. Cargo metadata, lockfile, and current release/versioning pages identify
   v0.2.74 while retaining v0.2.73 as the preceding public baseline.
2. Release CI produces the identity-bound five-target artifact and
   supply-chain receipt set for v0.2.74.
3. Public adopter and N-1 acceptance use only v0.2.74 downloaded artifacts,
