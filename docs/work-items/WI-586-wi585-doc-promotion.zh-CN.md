...
title: "WI-586——WI-585 终态文档晋级"
description: "在 WI-585 关闭后晋级其三语文档投影。"
...
[English](WI-586-wi585-doc-promotion.md) · [日本語](WI-586-wi585-doc-promotion.ja.md)

# WI-586——WI-585 终态文档晋级

## 目标

仅在 WI-585 的不可变 archive、verification、finalization 和 close receipt
...
1. 三个 WI-585 Work Item 页面包含由不可变 receipt 得出的终态路径。
2. 三语 reference-parity 行将 WI-585 标记为已实现并绑定对应 evidence 路径。
