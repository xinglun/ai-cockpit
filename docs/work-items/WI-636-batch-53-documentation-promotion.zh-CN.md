...
将三语 Work Item 与 parity 投影更新为权威的 WI-633/WI-634/WI-635 恢复谱系状态。
生成的 archive、evidence、finalization 和 close 字节保持不可变；本 Work Item 只
修改面向人的文档投影。

不包含 Runtime 行为、参考源复制、发布制品、对象工程或全局 Agent/MCP 配置。
