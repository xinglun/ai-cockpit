...
# WI-860 — 完了済み Work Item のドキュメント promotion

この Work Item は WI-859 の終端ドキュメント投影六件を反映します。派生ドキュメント操作であり、WI-859 を再開せず、実装動作を変更せず、不変の証拠を置き換えません。

このタスク自身にも三言語の投影を持たせ、ドキュメント promotion がレビュー境界を越える前に追跡可能であることを保証します。
