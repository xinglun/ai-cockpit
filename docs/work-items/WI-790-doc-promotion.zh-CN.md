...
title: "WI-790——WI-785 与 WI-787 文档投影"
...
[English](WI-790-doc-promotion.md) · [日本語](WI-790-doc-promotion.ja.md)

# WI-790——WI-785 与 WI-787 文档投影

## 意图与边界

WI-790 是有界的文档 Work Item。它使用不可变的 Runtime 记录晋级 WI-787
...
- WI-790 自身三语页面和 parity 行在 archive 前完成注册。
