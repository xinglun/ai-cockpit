...
repairs the tri-language projections, and records fresh verification before
Runtime finalization and close. It makes no production or performance change.
...
- Runtime generates the archive, finalization, Outcome, and close records.
