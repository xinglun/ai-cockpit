...
finalization, cleanup, and human close are recorded as separate terminal lifecycle evidence.
...
- Runtime generated the archive, Outcome, deleted cleanup transition, and close
  records.
