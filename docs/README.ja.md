...
| Governed task を開始する | [最初の Work Item](getting-started/first-work-item.ja.md) → [Work Item ルール](work-items/README.ja.md) | goal と boundary を宣言し、`start --prepare`、実装、検証、review/merge、cleanup を進める。詳細な resource 手順は Runtime reference に任せる。 |
