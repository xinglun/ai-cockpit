...
結果は `.ai/evidence/WI-745-p1-cognitive-benefit-evaluation.json`、読者向けの要約は
`.ai/evidence/external/WI-745-p1-cognitive-benefit-evaluation.md` に保存します。
