...
- 既存の immutable public baseline は `v0.2.105` です。現在の release baseline target は `v0.2.106` candidate であり、public adopter acceptance と N-1 upgrade 受入れは post-release evidence のままです。
