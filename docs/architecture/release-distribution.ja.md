...
- 既存の immutable public baseline は `v0.2.106` です。現在の release baseline target は `v0.2.107` candidate であり、public adopter acceptance と N-1 upgrade 受入れは post-release evidence のままです。
