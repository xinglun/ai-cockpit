...
以前の公開 `v0.2.48` Release は historical evidence として保持し、現在の baseline に置き換えます。
...
- 現在の immutable public baseline は `v0.2.49` で、public adopter acceptance と N-1 upgrade 受入れは post-release evidence です。
