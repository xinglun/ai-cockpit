...
`v0.2.50` is the preceding public patch release and remains historical evidence.
The failed `v0.2.49` tag is retained as unpublished history and is not reused;
`v0.2.51` is the current package identity.
