...
`v0.2.82` is the preceding public patch release and remains historical evidence;
...
`v0.2.82` remains the preceding public patch history; `v0.2.83` is the current package identity.
