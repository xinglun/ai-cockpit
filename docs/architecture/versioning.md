...
`v0.2.98` and `v0.2.99` are previous package identities, `v0.2.100` is the current public package identity, and `v0.2.101` is the unpublished candidate package identity. The immutable failed `v0.2.96`
