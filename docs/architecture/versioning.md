...
`v0.2.91` is the preceding public patch release and remains historical evidence;
...
`v0.2.91` remains the preceding public patch history; `v0.2.92` is the current package identity.
