...
`v0.2.63` is the preceding public patch release and remains historical evidence;
`v0.2.61`, `v0.2.55`, `v0.2.53`, and `v0.2.52` remain earlier historical evidence.
...
`v0.2.64` is the current package identity.
