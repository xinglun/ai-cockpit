...
`v0.2.79` is the preceding public patch release and remains historical evidence;
...
`v0.2.79` remains the preceding public patch history; `v0.2.80` is the current package identity.
