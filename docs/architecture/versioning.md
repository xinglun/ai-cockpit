...
`v0.2.76` is the preceding public patch release and remains historical evidence;
...
`v0.2.78` remains the preceding public patch history; `v0.2.79` is the current package identity.
