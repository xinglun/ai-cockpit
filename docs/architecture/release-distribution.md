...
The current immutable release baseline is `v0.2.57` after publication; before
its provider Release exists, `v0.2.55` remains the installable public baseline.
...
The prior public `v0.2.55` Release remains retained as historical evidence and
is superseded by this baseline; `v0.2.53` and `v0.2.52` remain earlier historical evidence.
...
- `cockpit-release` and the release workflow own the local release contract,
  ...
  Release identity.
- The current immutable public baseline is `v0.2.57`; the public adopter
