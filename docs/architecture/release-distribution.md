...
The current immutable release baseline is `v0.2.47`. The failed `v0.2.35` tag
...
The prior public `v0.2.45` Release remains retained as historical evidence and
...
- `cockpit-release` and the release workflow own the local release contract,
  ...
  Release identity.
- The current immutable public baseline is `v0.2.47`; the public adopter
