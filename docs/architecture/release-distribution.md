...
The current immutable release baseline is `v0.2.64` after publication; before
its provider Release exists, `v0.2.63` remains the installable public baseline.
...
The prior public `v0.2.63` Release remains retained as historical evidence and
...
- `cockpit-release` and the release workflow own the local release contract,
  ...
  Release identity.
- The current immutable public baseline is `v0.2.64`; the public adopter
