...
The current immutable release baseline is `v0.2.79` after publication; before
its provider Release exists, `v0.2.78` remains the installable public baseline.
...
- `cockpit-release` and the release workflow own the local release contract,
  ...
  Release identity.
- The current immutable public baseline is `v0.2.79`; the public adopter
