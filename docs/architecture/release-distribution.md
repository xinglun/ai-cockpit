...
The current public Release is `v0.2.113`; its public Release and post-release
acceptance are complete, so it is the immutable public installation baseline.
The preceding public `v0.2.106` Release remains historical evidence.
...
The failed `v0.2.84` tag is retained as immutable pre-publication history after
the source-quality gate stopped its workflow; it is never reused or treated as
an installation baseline.
The `v0.2.111` tag is retained as immutable unpublished candidate history after
its five-target release workflow was canceled before publication; it is never
reused or treated as an installation baseline.
The `v0.2.77` tag is retained as immutable failed-publication history with no
provider Release and is never an installation baseline.
...
The prior public `v0.2.72` Release remains retained as historical evidence and
is superseded by this baseline; `v0.2.61`, `v0.2.55`, `v0.2.53`, and `v0.2.52` remain earlier historical evidence.
...
- `cockpit-release` and the release workflow own the local release contract,
  ...
  Release identity.
- The immutable public installation baseline is `v0.2.113`; its public adopter
  acceptance and N-1 upgrade acceptance are complete. The preceding public
  `v0.2.106` Release remains historical evidence. An external Homebrew tap is a separate provider surface
