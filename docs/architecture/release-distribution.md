...
The current immutable release baseline is `v0.2.58` after publication; before
its provider Release exists, `v0.2.57` remains the installable public baseline.
...
The prior public `v0.2.57` Release remains retained as historical evidence and
...
- `cockpit-release` and the release workflow own the local release contract,
  ...
  Release identity.
- The current immutable public baseline is `v0.2.58`; the public adopter
