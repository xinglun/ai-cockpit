...
当前不可变发布基线是 `v0.2.35`。失败的 `v0.2.34` 标签因 workflow run
`33155382717` 没有公开 Release，作为不可变发布历史保留。失败的 staged `v0.2.32` 标签因 WI-299
...
- 当前不可变公开基线是 `v0.2.35`；public adopter acceptance 和 N-1 升级验收属于发布后 evidence。外部 Homebrew tap 是
