...
当前发布候选是 `v0.2.110`；在公开 Release 和发布后验收完成之前，它不是安装基线。当前不可变公开安装基线是 `v0.2.106`。
...
- 已公开的不可变安装基线是 `v0.2.106`；当前发布基线目标是 `v0.2.110` 候选，public adopter acceptance 和 N-1 升级验收仍属于发布后 evidence。外部 Homebrew tap 是
