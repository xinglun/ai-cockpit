...
- [Collaboration invariant coverage](collaboration-invariant-coverage.md) — maps the ten collaboration-language invariants to existing automated test coverage, citing exact tests and stating remaining boundaries.
