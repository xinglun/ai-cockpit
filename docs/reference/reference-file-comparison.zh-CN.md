...
- 比较时使用审查中的 Runtime：`ai-cockpit v0.2.95`，binary SHA256 为 `sha256:b0093967b939533e871e6f5359a6c01268dcd864a09b8e030001484b4785228b`。
...
审查使用的 Runtime 为 v0.2.95，二进制摘要为
