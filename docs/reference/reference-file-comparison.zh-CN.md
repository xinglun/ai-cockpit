...
- 比较时使用审查中的 Runtime：`ai-cockpit v0.2.92`，binary SHA256 为 `sha256:86433dddb11bb78553b080546a4a465581faaf79e46dfc431cbeda14c8515da6`。
...
审查使用的 Runtime 为 v0.2.92，二进制摘要为
