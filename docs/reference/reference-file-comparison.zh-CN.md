...
- 比较时使用审查中的 Runtime：`ai-cockpit v0.2.98`，binary SHA256 为 `sha256:cdbe03cb72651abd57d3b8ee107239a778f8c658186480e5a31cc6628ee22299`。
...
审查使用的 Runtime 为 v0.2.98，二进制摘要为
