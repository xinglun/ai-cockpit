...
- 比较时使用审查中的 Runtime：`ai-cockpit v0.2.87`，binary SHA256 为 `sha256:5cb247d6252059362fbb53d973827643a430393490a2766e48c128b647f68af8`。
...
审查使用的 Runtime 为 v0.2.87，二进制摘要为
