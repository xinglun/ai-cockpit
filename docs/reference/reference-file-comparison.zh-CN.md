...
- 比较时使用审查中的 Runtime：`ai-cockpit v0.2.91`，binary SHA256 为 `sha256:75a262eed94fa705530946b64fac93ce441a5b7eeeb2cdb36d0f409346a420fc`。
...
审查使用的 Runtime 为 v0.2.91，二进制摘要为
