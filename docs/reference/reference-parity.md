...
| WI-201 — governance gate post-merge reconciliation (current) | In progress | [Work Item](../work-items/WI-201-governance-gate-post-merge-reconciliation.md); `.ai/evidence/WI-201-governance-gate-post-merge-reconciliation.verification.json`; `.ai/decisions/WI-201-governance-gate-post-merge-reconciliation.finalize.json`; merged PR #153, current default-branch gate, and terminal closure receipts. |
