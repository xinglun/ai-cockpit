...
| WI-210 — v0.2.26 immutable release and adopter acceptance (current) | Implemented | [Work Item](../work-items/WI-210-release-v0-2-26.md); `.ai/evidence/WI-210-release-v0-2-26.verification.json`; `.ai/decisions/WI-210-release-v0-2-26.finalize.json`; source release baseline and premerge finalization are bound, while immutable tag/public adopter/upgrade/close evidence remain the post-merge boundary. |
