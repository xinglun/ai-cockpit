...
| WI-197 — governance gate PR closure (current) | In progress | [Work Item](../work-items/WI-197-governance-gate-pr-closure.md); `.ai/evidence/WI-197-governance-gate-pr-closure.verification.json`; `.ai/decisions/WI-197-governance-gate-pr-closure.finalize.json`; fresh parity and PR-resource binding correction from hosted quality feedback. |
