...
| WI-210 — v0.2.26 immutable release and adopter acceptance (current) | In progress | [Work Item](../work-items/WI-210-release-v0-2-26.md); the release verification, premerge finalize receipt, immutable tag, public adopter/upgrade acceptance, and installed Runtime close evidence are bound here. |
