...
| WI-177 — v0.2.22 public adopter acceptance baseline | In progress | Installed public v0.2.22 binary SHA256 `fff455d0d88d9ca4fa96b5caba85d8a6a198e131bd6ecc5a33dd9bc5cc180ab2`; public archive SHA256 `b74857298bc32b53a8b7a349b5d719cb670c4d9beb25b2414b562e4a7e13a145`; isolated adopter evidence is being recorded under `.ai/evidence/WI-177-post-release-adopter-v0-2-22/`, including runtime identity, attach/profile/agent doctor, not_ready scaffold, evidence reuse, lifecycle, isolation, and cleanup. |
