...
| WI-170 — v0.2.20 post-release parity and branch reconciliation | In progress | This Work Item records the post-release documentation correction and exact merged-branch cleanup proof before the next comparison batch. |
| WI-171 — finalization reconciliation successor | In progress | This successor binds WI-170's immutable recovery decision to the missing resource-finalization boundary before close. |
