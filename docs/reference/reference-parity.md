...
| WI-196 — governance-integrity recovery gate retry (current) | Implemented | [Work Item](../work-items/WI-196-governance-recovery-gate-retry.md); fresh checkpoint-bound re-verification of the same current-batch delivery. |
