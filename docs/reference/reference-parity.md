...
| WI-208 — release-tag finalization ordering (current) | Implemented | [Work Item](../work-items/WI-208-release-tag-pending-close-finalization.md); `.ai/evidence/WI-208-release-tag-pending-close-finalization.verification.json`; `.ai/decisions/WI-208-release-tag-pending-close-finalization.finalize.json`; the exact PR #158 context is bound before verification and remains awaiting merge-close. |
