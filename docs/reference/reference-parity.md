...
| Public Release and fresh-adopter acceptance | Partial | The complete v0.2.10 post-release adopter baseline runs on `x86_64-unknown-linux-gnu`; the other targets have build/smoke evidence, not the full lifecycle. |
