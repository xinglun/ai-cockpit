...
| WI-203 — v0.2.25 release and transition compatibility (current) | In progress | [Work Item](../work-items/WI-203-release-v0-2-25.md); v0.2.25 public Release, adopter acceptance, and installed transition support are bound here. |
