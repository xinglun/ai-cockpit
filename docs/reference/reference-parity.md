...
| WI-206 — release-tag pending-close governance boundary (current) | In progress | [Work Item](../work-items/WI-206-release-tag-pending-close.md); release-tag ancestor proof and ordinary-branch fail-closed regression are being added before the next immutable Release retry. |
