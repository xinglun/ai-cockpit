...
| WI-205 — v0.2.25 release and transition compatibility recovery (current) | In progress | [Work Item](../work-items/WI-205-release-v0-2-25.md); v0.2.25 public Release, adopter acceptance, and installed transition support are bound here after the correct default-branch base and `finalize-plan` are recorded. |
