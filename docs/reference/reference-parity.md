...
| WI-183 — v0.2.23 release baseline | In progress | This Work Item updates the tri-language current release baseline to v0.2.23 while preserving v0.2.22 as the adjacent N-1 release. Public Release, adopter, and N-1 evidence remain post-release facts. |
