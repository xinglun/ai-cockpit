...
| WI-167 — v0.2.19 public Release and adopter acceptance | In progress | This release Work Item binds the versioned source baseline to the immutable public v0.2.19 binary, then records public adopter and v0.2.18-to-v0.2.19 N-1 acceptance evidence without rewriting v0.2.18 history. |
