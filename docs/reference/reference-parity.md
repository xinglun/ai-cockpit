...
| WI-205 — v0.2.25 release and transition compatibility recovery (current) | In progress | [Work Item](../work-items/WI-205-release-v0-2-25.md); `.ai/evidence/WI-205-release-v0-2-25.verification.json`; `.ai/decisions/WI-205-release-v0-2-25.finalize.json`; v0.2.25 public Release, adopter acceptance, and installed transition support are bound here after the correct default-branch base and `finalize-plan` are recorded. |
...
| WI-209 — release-tag finalization ordering (current) | Implemented | [Work Item](../work-items/WI-209-release-tag-pending-close-finalization.md); `.ai/evidence/WI-209-release-tag-pending-close-finalization.verification.json`; `.ai/decisions/WI-209-release-tag-pending-close-finalization.finalize.json`; PR #158 is bound to the synchronized default-branch base before verification and remains awaiting merge-close. |
