...
| WI-200——治理质量门 GitHub head 绑定（当前） | 进行中 | [Work Item](../work-items/WI-200-governance-gate-github-head-binding.zh-CN.md)；`.ai/evidence/WI-200-governance-gate-github-head-binding.verification.json`；`.ai/decisions/WI-200-governance-gate-github-head-binding.finalize.json`；合并前精确绑定 PR #153 head ref/SHA。 |
