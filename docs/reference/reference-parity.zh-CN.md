...
| WI-212——WI-211 收尾恢复（等待合并关闭） | 进行中 | [Work Item](../work-items/WI-212-release-fixture-finalization-recovery.zh-CN.md)；`.ai/evidence/WI-212-release-fixture-finalization-recovery.verification.json`；`.ai/decisions/WI-211-hermetic-governance-fixture.recovery.json`；`.ai/decisions/WI-212-release-fixture-finalization-recovery.finalize.json`；保留 WI-211 不可变 recovered history，并记录 PR #160 的合并前资源收尾边界；合并关闭仍待完成。 |
| WI-213——v0.2.27 不可变发布与 adopter 验收（等待合并） | 进行中 | [Work Item](../work-items/WI-213-release-v0-2-27.zh-CN.md)；`.ai/evidence/WI-213-release-v0-2-27.verification.json`；`.ai/decisions/WI-213-release-v0-2-27.finalize.json`；v0.2.27 从已合并的 PR #160 准备并完成合并前 evidence；PR #161 合并、公开 artifact、adopter 验收和 WI-212 post-merge close 仍待完成。 |
