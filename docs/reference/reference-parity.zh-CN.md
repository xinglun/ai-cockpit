...
| WI-229——有界 governance append parity 恢复 | 已实现 | `.ai/evidence/WI-229-governance-append-parity-recovery.verification.json`；`.ai/decisions/WI-228-governance-append-evidence.recovery.json`；`.ai/decisions/WI-229-governance-append-parity-recovery.finalize.json`。successor 从远端默认分支承载有界 validator 交付，保留 WI-228 的不可变事实，并在 reviewed merge 前绑定精确的三语 parity 登记。 |
