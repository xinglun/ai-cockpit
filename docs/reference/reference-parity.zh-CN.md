...
| WI-216——v0.2.28 不可变发布与 adopter 验收 | 进行中 | [Work Item](../work-items/WI-216-release-v0-2-28.zh-CN.md)；`.ai/evidence/WI-216-release-v0-2-28.verification.json`；`.ai/decisions/WI-216-release-v0-2-28.preflight-review.json`；Release tag 与发布后验收等待 reviewed PR。 |
