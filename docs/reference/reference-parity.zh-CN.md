...
| WI-210——v0.2.26 不可变发布与 adopter 验收（当前） | 进行中 | [Work Item](../work-items/WI-210-release-v0-2-26.zh-CN.md)；发布 verification、合并前 finalize 回执、不可变 tag、公开 adopter/upgrade 验收和安装版 Runtime close 证据将在本 WI 绑定。 |
