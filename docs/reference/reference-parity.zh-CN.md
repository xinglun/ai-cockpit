...
| WI-197——治理质量门 PR 收敛（当前） | 进行中 | [Work Item](../work-items/WI-197-governance-gate-pr-closure.zh-CN.md)；`.ai/evidence/WI-197-governance-gate-pr-closure.verification.json`；`.ai/decisions/WI-197-governance-gate-pr-closure.finalize.json`；根据托管 quality 反馈进行 parity 与 PR resource binding 修正。 |
