...
| WI-205——v0.2.25 发布与 transition 兼容性恢复（当前） | 进行中 | [Work Item](../work-items/WI-205-release-v0-2-25.zh-CN.md)；在记录正确默认分支 base 与 `finalize-plan` 后，由本 WI 绑定 v0.2.25 公开 Release、adopter acceptance 与安装版 transition 支持。 |
