...
| WI-166——发布 adopter 验收资源收尾 | 已实现 | [Work Item](../work-items/WI-166-release-acceptance-finalization.zh-CN.md)；公开与 N-1 harness 现在会在结构化 close 前绑定资源收尾。v0.2.18 原始 workflow 失败保持为不可变的发布历史。 |
