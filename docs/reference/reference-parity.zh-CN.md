...
| WI-203——v0.2.25 发布与 transition 兼容性（当前） | 进行中 | [Work Item](../work-items/WI-203-release-v0-2-25.zh-CN.md)；v0.2.25 公开 Release、adopter acceptance 与安装版 transition 支持由本 WI 绑定。 |
