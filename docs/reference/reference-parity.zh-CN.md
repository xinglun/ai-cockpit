...
| WI-230——v0.2.29 发布与已安装 Runtime 采用 | 进行中 | `.ai/work-items/active/WI-230-release-v0-2-29.contract.json`；不可变 tag 发布后将补充 public Release、adopter、upgrade 与 close evidence。本 Release 承载已合并的 WI-229 Runtime 修复，并作为剩余收尾和验收使用的 Runtime。 |
