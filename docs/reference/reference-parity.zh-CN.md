...
| WI-213——v0.2.27 不可变发布与 adopter 验收（等待合并） | 进行中 | [Work Item](../work-items/WI-213-release-v0-2-27.zh-CN.md)；`.ai/evidence/WI-213-release-v0-2-27.verification.json`；v0.2.27 从已合并的 PR #160 准备并完成合并前 evidence；PR #161 合并、公开 artifact、adopter 验收和 WI-212 post-merge close 仍待完成。 |
