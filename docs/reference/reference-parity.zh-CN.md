...
| WI-177——v0.2.22 公开 adopter 验收基线 | 进行中 | 已安装公开 v0.2.22 binary SHA256 `fff455d0d88d9ca4fa96b5caba85d8a6a198e131bd6ecc5a33dd9bc5cc180ab2`；公开 archive SHA256 `b74857298bc32b53a8b7a349b5d719cb670c4d9beb25b2414b562e4a7e13a145`；隔离 adopter 证据写入 `.ai/evidence/WI-177-post-release-adopter-v0-2-22/`，包含 runtime identity、attach/profile/agent doctor、not_ready scaffold、证据复用、完整 lifecycle、隔离与清理。 |
