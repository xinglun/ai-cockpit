...
| WI-202——v0.2.24 发布与 transition 兼容性（当前） | 进行中 | [Work Item](../work-items/WI-202-release-v0-2-24.zh-CN.md)；`.ai/evidence/WI-202-release-v0-2-24.verification.json`；`.ai/decisions/WI-202-release-v0-2-24.finalize.json`；绑定 v0.2.24 公开 Release、adopter acceptance 与安装版 transition 支持。 |
