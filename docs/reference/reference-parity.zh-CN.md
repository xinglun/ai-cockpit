...
| WI-211——治理 fixture 事件上下文隔离（当前） | 进行中 | [Work Item](../work-items/WI-211-hermetic-governance-fixture.zh-CN.md)；修复 release-tag GitHub 环境变量泄漏到普通治理 fixture 的问题；修复后的 source-quality 重跑与新的发布边界尚未完成。 |
