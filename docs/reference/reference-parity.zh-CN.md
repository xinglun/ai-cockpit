...
| WI-206——Release tag 待关闭治理边界（当前） | 进行中 | [Work Item](../work-items/WI-206-release-tag-pending-close.zh-CN.md)；在下一次不可变 Release 重试前增加 Release tag 祖先证明与普通分支 fail-closed 回归。 |
