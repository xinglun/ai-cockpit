...
| WI-230——v0.2.29 发布基线 | 进行中 | `.ai/work-items/archive/WI-230-release-v0-2-29.archive.json`；`.ai/evidence/WI-230-release-v0-2-29.verification.json`；预发布基线承载已合并的 WI-229 Runtime 修复，并绑定已审阅 PR 后再进入不可变发布。public Release、adopter、upgrade 与已安装 Runtime 验收属于发布后的独立 successor 范围。 |
