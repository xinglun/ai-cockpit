...
| WI-211 — governance fixture の event context 分離（current） | In progress | [Work Item](../work-items/WI-211-hermetic-governance-fixture.ja.md)；release-tag の GitHub environment variables が通常 fixture に漏れる問題を修正します。修正後の source-quality 再実行と新しい release boundary は未完了です。 |
