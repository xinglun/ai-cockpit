...
| WI-169 — v0.2.20 公開 Release と adopter acceptance | In progress | この Work Item は修正済み N-1 harness を v0.2.20 として公開し、immutable な public adopter と v0.2.19→v0.2.20 N-1 acceptance evidence を記録します。 |
