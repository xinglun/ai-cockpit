...
| WI-200 — governance gate GitHub head binding（current） | In progress | [Work Item](../work-items/WI-200-governance-gate-github-head-binding.ja.md)；`.ai/evidence/WI-200-governance-gate-github-head-binding.verification.json`；`.ai/decisions/WI-200-governance-gate-github-head-binding.finalize.json`；merge 前の正確な PR #153 head ref/SHA binding。 |
