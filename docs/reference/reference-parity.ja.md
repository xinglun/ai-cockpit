...
| WI-179 — v0.2.22 post-release parity correction | In progress | この Work Item は三言語 parity document を WI-177 adopter acceptance 完了、WI-178 finalization closure 完了の状態へ同期します。 |
