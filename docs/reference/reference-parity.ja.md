...
| WI-167 — v0.2.19 公開 Release と adopter acceptance | In progress | versioned source baseline と immutable な v0.2.19 binary を bind し、v0.2.18 の履歴を書き換えずに public adopter と v0.2.18→v0.2.19 N-1 acceptance evidence を記録します。 |
