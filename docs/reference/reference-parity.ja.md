...
| WI-196 — governance-integrity recovery gate retry（current） | Implemented | [Work Item](../work-items/WI-196-governance-recovery-gate-retry.ja.md)；同じ current-batch delivery の fresh checkpoint-bound re-verification。 |
