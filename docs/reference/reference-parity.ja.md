...
| WI-216 — v0.2.28 immutable Release と adopter acceptance | In progress | [Work Item](../work-items/WI-216-release-v0-2-28.ja.md)；`.ai/evidence/WI-216-release-v0-2-28.verification.json`；`.ai/decisions/WI-216-release-v0-2-28.preflight-review.json`；`.ai/decisions/WI-216-release-v0-2-28.finalize.json`；Release tag と post-release acceptance は reviewed PR 後まで pending です。 |
