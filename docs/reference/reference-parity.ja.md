...
| WI-183 — v0.2.23 release baseline | In progress | この Work Item は三言語の current release baseline を v0.2.23 に更新し、隣接する N-1 Release として v0.2.22 を保持します。公開 Release、adopter、N-1 evidence は post-release の事実です。 |
