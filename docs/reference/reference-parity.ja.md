...
| WI-210 — v0.2.26 immutable release と adopter acceptance（current） | Implemented | [Work Item](../work-items/WI-210-release-v0-2-26.ja.md)；`.ai/evidence/WI-210-release-v0-2-26.verification.json`；`.ai/decisions/WI-210-release-v0-2-26.finalize.json`；release baseline と premerge finalization を bind 済みで、immutable tag、public adopter/upgrade、close evidence は merge 後の境界です。 |
