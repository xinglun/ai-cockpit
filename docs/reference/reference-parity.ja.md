...
| WI-205 — v0.2.25 release and transition compatibility recovery（current） | In progress | [Work Item](../work-items/WI-205-release-v0-2-25.ja.md)；正しい default-branch base と `finalize-plan` を記録した上で、v0.2.25 public Release、adopter acceptance、installed transition support をここで binding します。 |
