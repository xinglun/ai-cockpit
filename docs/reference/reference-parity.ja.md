...
| WI-197 — governance gate PR closure（current） | In progress | [Work Item](../work-items/WI-197-governance-gate-pr-closure.ja.md)；hosted quality feedback に基づく parity と PR resource binding の修正。 |
