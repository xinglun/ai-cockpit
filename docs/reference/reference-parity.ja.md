...
| WI-197 — governance gate PR closure（current） | In progress | [Work Item](../work-items/WI-197-governance-gate-pr-closure.ja.md)；`.ai/evidence/WI-197-governance-gate-pr-closure.verification.json`；`.ai/decisions/WI-197-governance-gate-pr-closure.finalize.json`；hosted quality feedback に基づく parity と PR resource binding の修正。 |
