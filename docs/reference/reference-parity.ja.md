...
| WI-206 — release tag の pending-close governance boundary（current） | In progress | [Work Item](../work-items/WI-206-release-tag-pending-close.ja.md)；次の immutable Release retry 前に、Release tag の ancestor proof と通常 branch の fail-closed regression を追加します。 |
