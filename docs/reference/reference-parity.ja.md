...
| WI-180 — parity status closure correction | Implemented | 最終 self-check で発見した WI-179 の stale status を記録する corrective Work Item です。三言語の修正と再発防止 evidence は `.ai/evidence/WI-180-parity-status-closure-correction/` に bind されています。 |
