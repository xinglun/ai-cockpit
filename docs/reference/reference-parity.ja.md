...
| WI-201 — governance gate post-merge reconciliation（current） | In progress | [Work Item](../work-items/WI-201-governance-gate-post-merge-reconciliation.ja.md)；`.ai/evidence/WI-201-governance-gate-post-merge-reconciliation.verification.json`；`.ai/decisions/WI-201-governance-gate-post-merge-reconciliation.finalize.json`；merge 済み PR #153、current default-branch gate、terminal closure receipt を binding します。 |
