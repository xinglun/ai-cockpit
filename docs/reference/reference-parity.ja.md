...
| WI-212 — WI-211 finalization recovery（current） | In progress | [Work Item](../work-items/WI-212-release-fixture-finalization-recovery.ja.md)；WI-211 の immutable recovered history を保持し、successor verification 前に PR #160 の resource finalization を戻します。merge close は未完了です。 |
