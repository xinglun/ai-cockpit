...
| WI-210 — v0.2.26 immutable release と adopter acceptance（current） | In progress | [Work Item](../work-items/WI-210-release-v0-2-26.ja.md)；release verification、premerge finalize receipt、immutable tag、public adopter/upgrade acceptance、installed Runtime close evidence をここで binding します。 |
