...
| WI-213 — v0.2.27 immutable release と adopter acceptance（current） | In progress | [Work Item](../work-items/WI-213-release-v0-2-27.ja.md)；merge 済み PR #160 から v0.2.27 を準備し、public artifact、adopter acceptance、WI-212 の post-merge close は未完了です。 |
