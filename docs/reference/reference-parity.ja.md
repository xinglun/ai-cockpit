...
| WI-166 — Release adopter acceptance の resource finalization | Implemented | [Work Item](../work-items/WI-166-release-acceptance-finalization.ja.md); public と N-1 harness は structured close 前に resource finalization を bind する。v0.2.18 の original workflow failure は immutable な Release history として保持する。 |
