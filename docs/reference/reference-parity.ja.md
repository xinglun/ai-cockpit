...
| WI-212 — WI-211 finalization recovery（awaiting merge close） | In progress | [Work Item](../work-items/WI-212-release-fixture-finalization-recovery.ja.md)；`.ai/evidence/WI-212-release-fixture-finalization-recovery.verification.json`；`.ai/decisions/WI-211-hermetic-governance-fixture.recovery.json`；`.ai/decisions/WI-212-release-fixture-finalization-recovery.finalize.json`；WI-211 の immutable recovered history を保持し、PR #160 の pre-merge resource finalization boundary を記録しました。merge close は未完了です。 |
| WI-213 — v0.2.27 immutable release と adopter acceptance（awaiting merge） | In progress | [Work Item](../work-items/WI-213-release-v0-2-27.ja.md)；`.ai/evidence/WI-213-release-v0-2-27.verification.json`；merge 済み PR #160 から v0.2.27 を準備し pre-merge evidence を archive 済みです。PR #161 の merge、public artifact、adopter acceptance、WI-212 の post-merge close は未完了です。 |
