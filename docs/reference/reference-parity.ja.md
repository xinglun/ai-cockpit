...
| WI-202 — v0.2.24 release and transition compatibility（current） | In progress | [Work Item](../work-items/WI-202-release-v0-2-24.ja.md)；`.ai/evidence/WI-202-release-v0-2-24.verification.json`；`.ai/decisions/WI-202-release-v0-2-24.finalize.json`；v0.2.24 public Release、adopter acceptance、installed transition support を binding します。 |
