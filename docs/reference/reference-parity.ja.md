...
| Public Release と fresh-adopter acceptance | Partial | v0.2.12 の complete post-release adopter baseline は `x86_64-unknown-linux-gnu` のみ。他の target は build/smoke evidence である。 |
