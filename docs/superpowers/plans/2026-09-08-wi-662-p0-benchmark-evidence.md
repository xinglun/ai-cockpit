...
- Base: `origin/main` at `9b53118fa992c917242a837b17592ffd660ddd23`
- Scope: `tests/performance/**`, this Work Item record, reference parity rows, and this plan.
...
4. Run focused tests, docs/parity checks, and one sanity benchmark. Report
