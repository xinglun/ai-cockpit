...
- [x] **Step 3: Pin the extracted binary**
...
- [x] **Step 4: Add the failure finalizer**
...
- [x] **Step 5: Run the focused shell assertions**
...
- [x] **Step 6: Commit the harness contract**
...
- [x] **Step 1: Create isolated directories and baseline snapshots**
...
- [x] **Step 4: Preserve `first-adopter-smoke` as not ready**
...
- [x] **Step 5: Run a complete lifecycle Work Item**
...
- [x] **Step 6: Bind and verify evidence reuse**
...
- [x] **Step 7: Prove isolation and finalize hashes**
...
- [x] **Step 8: Run the adopter lifecycle test**
...
- [x] **Step 1: Add the tag-only job and permissions**
...
- [x] **Step 4: Extend workflow policy tests**
...
- [x] **Step 5: Run workflow policy and YAML checks**
...
- [x] **Step 1: Record WI-40 scope and acceptance criteria in three languages**
...
- [x] **Step 5: Commit, push, hosted-check, merge, and clean**
...
The harness, post-publication workflow job, trilingual documentation, and closed
Work Item evidence were completed locally. The public `v0.1.1` aarch64 macOS
acceptance passed using only the downloaded Release archive; the artifact bundle
contains runtime identity, attach/inspect/profile/Agent/doctor/verification
evidence, zero-spawn reuse, the not-ready first-adopter skeleton, the complete
Work Item lifecycle, isolation proof, and `SHA256SUMS`. Hosted tag execution
remains the recurring post-release confirmation for future immutable tags.
