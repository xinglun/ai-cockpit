...
pub use interface_description::{
    ...
    OutcomeParameterDefinition, WORK_ITEM_OUTCOME_CANONICAL_DELIVERY,
    ...
    WORK_ITEM_OUTCOME_CANONICAL_WORK_ITEM_ID, WORK_ITEM_OUTCOME_DEFAULT_DELIVERY,
    ...
    WORK_ITEM_OUTCOME_LANGUAGE_VALUES, WORK_ITEM_OUTCOME_SURFACE,
    WORK_ITEM_OUTCOME_VIEW_DESCRIPTION, WORK_ITEM_OUTCOME_VIEW_FULL,
    WORK_ITEM_OUTCOME_VIEW_SUMMARY, WORK_ITEM_OUTCOME_VIEW_VALUES, capability_show_format_is_valid,
    ...
    work_item_outcome_parameter_spec_by_canonical, work_item_outcome_view_is_valid,
};
