...
fn render_fixture(
    ...
    let outcome = OutcomeV2 {
        ...
        historical_status: historical_status.map(str::to_owned),
    };
...
fn human_renderer_separates_verification_lifecycle_and_human_decision() {
    ...
    let text = render_fixture(
        ...
        vec![],
        vec![".ai/evidence/WI-OUTCOME-TRUST.verification.json".into()],
    );
...
fn human_renderer_does_not_infer_risk_absence_or_test_strength_from_empty_fields() {
    ...
    let text = render_fixture(
        ...
        sections,
        vec![],
        vec![".ai/evidence/WI-OUTCOME-RISK-BOUNDARY.verification.json".into()],
    );
    assert!(
        text.contains(
...
fn human_renderer_preserves_historical_and_superseded_distinctions() {
    ...
    let historical = render_fixture(
        ...
        vec![".ai/evidence/historical.json".into()],
    );
    ...
    let superseded = render_fixture(
        ...
        Some("superseded"),
        OutcomeReportSections::default(),
        vec!["historical_evidence_not_current".into()],
        vec![".ai/evidence/superseded.json".into()],
    );
...
fn human_renderer_keeps_partial_missing_and_stale_verification_distinct() {
    ...
    let partial = render_fixture(
        ...
        None,
        OutcomeReportSections::default(),
        vec!["verification_scope_incomplete".into()],
        vec![".ai/evidence/partial.json".into()],
    );
    ...
    let missing = render_fixture(
        ...
        None,
        OutcomeReportSections::default(),
        vec!["required_evidence_missing".into()],
        vec![],
    );
    ...
    let stale = render_fixture(
        ...
        None,
        OutcomeReportSections::default(),
        vec!["evidence_snapshot_stale".into(), "identity_mismatch".into()],
        vec![".ai/evidence/stale.json".into()],
    );
