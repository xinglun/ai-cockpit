...
knowledge_projection_source="$repo_root/crates/cockpit-repository/src/knowledge_projection.rs"
...
grep -Fq 'fn implementation_approach_internal(' "$knowledge_projection_source"
grep -Fq 'if persist {' "$knowledge_projection_source"
