...
python3 "$script" --manifest "$manifest" --source-commit e5acb677da6621004d96f0ef353c58fe8d3acfbf --target-commit 1c988ce9b04c3dcd45843f6577ed321457eeca0e --check
...
if python3 "$script" --manifest "$tmp/empty-capability-classification.json" --source-commit e5acb677da6621004d96f0ef353c58fe8d3acfbf --target-commit 1c988ce9b04c3dcd45843f6577ed321457eeca0e --check; then
...
if python3 "$script" --manifest "$tmp/invalid.json" --source-commit e5acb677da6621004d96f0ef353c58fe8d3acfbf --target-commit 1c988ce9b04c3dcd45843f6577ed321457eeca0e --check; then
  echo "inventory accepted an unclassified record" >&2
  exit 1
fi

jq '.targetWorkingTreeFileCount += 1' "$manifest" > "$tmp/working-tree-drift.json"
if python3 "$script" --manifest "$tmp/working-tree-drift.json" --source-commit e5acb677da6621004d96f0ef353c58fe8d3acfbf --target-commit 1c988ce9b04c3dcd45843f6577ed321457eeca0e --check; then
...
python3 "$script" \
  ...
  --target-commit 1c988ce9b04c3dcd45843f6577ed321457eeca0e \
